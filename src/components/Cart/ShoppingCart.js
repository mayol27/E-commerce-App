...
const ShoppingCart = () => {
	return (
		<div className="mx-auto flex flex-col max-w-3xl p-6 space-y-4 sm:p-10 bg-gray-100 my-5">
			...
			<ul className="flex flex-col divide-y divide-gray-700">
				...
				<li className="flex flex-col py-6 sm:flex-row sm:justify-between">
					<div className="flex w-full space-x-2 sm:space-x-4">
						<img
							className="flex-shrink-0 object-cover w-20 h-20 border-transparent rounded outline-none sm:w-32 sm:h-32 bg-gray-700"
			...
			<div className="flex justify-end space-x-4">
				<button
					type="button"
					className="px-6 py-2 border rounded-md border-gray-400 hover:text-white hover:border-white hover:bg-black"
				>
					<span className="sr-only sm:not-sr-only"> Back to shop</span>
				</button>
				<button
					type="button"
					className="px-6 py-2 border rounded-md bg-red-600  border-white hover:bg-red-400"
				>
